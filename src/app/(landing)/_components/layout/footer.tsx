  ...
  return (
    <div className="flex w-full flex-col items-start justify-start">
      <div className="flex h-auto flex-col items-stretch justify-between self-stretch pt-0 pr-0 pb-8 md:flex-row">
        <div className="flex h-auto flex-col items-start justify-start gap-8 p-4 md:p-8 text-accent-foreground">
            ...
            <div className="flex flex-col items-start justify-start gap-2">
              {company.email && (
                <a
                  ...
                  className="font-normal font-sans text-secondary-foreground text-sm leading-5 transition-colors hover:text-foreground"
                >
                  {company.email}
                </a>
              )}
              ...
              {company.address && (
                <div className="font-normal font-sans text-secondary-foreground text-sm leading-5">
